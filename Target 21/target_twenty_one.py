...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Hello, Welcome to Target Twenty One! <break/>" \
    ...
    card_output = "Hello, Welcome to Target Twenty One! " \
...
def handle_session_end_request():
    ...
    speech_output = "<say-as interpret-as=\"interjection\">All for now folks.</say-as><break/> "\
                    "Thank you for playing Target Twenty One! <break/>" \
                    "I hope you had fun. <break/>"\
                    "Come back to have more fun and to discover more tricks to win. <break/>"\
                    "<say-as interpret-as=\"interjection\">Ta ta! See you later.</say-as><break/> Bye bye! Have a nice day! "
    card_output = "All for now folks. "\
                    "Thank you for playing Target Twenty One! " \
                    "I hope you had fun. "\
                    "Come back to have more fun and to discover more tricks to win. "\
                    "Ta ta! See you later. Bye bye! Have a nice day! "
...
def set_number(intent, session):
    ...
    if start_game==1:
        ...
        if 'num' in intent['slots']:
            ...
            if user_num == "1":
                ...
                if n1 == c1+1 or n1 == c1+2:
                    ...
                    session_attributes = computer_number(comp_old_num)
                    if int(comp_old_num)<21:
                        o1=str(int(comp_old_num)+1)
                        o2=str(int(comp_old_num)+2)
                        speech_output = "<audio src='soundbank://soundlibrary/ui/gameshow/amzn_ui_sfx_gameshow_negative_response_01'/>"\
                                        "<say-as interpret-as=\"interjection\">Haanji.</say-as> What you are trying to pull buddy?<break/>You have said a wrong number. <break/>" \
                                       "Please try again. <break/>"\
                                       "Say your number by saying my number is "+ o1+ " ,or, " + o2 +\
                                       ".<audio src='soundbank://soundlibrary/ui/gameshow/amzn_ui_sfx_gameshow_player1_01'/>"
                        card_output = "Haanji. What you are trying to pull buddy? You have said a wrong number." \
                                       "Please try again. "\
                                       "Say your number by saying, my number is " + o1+ " or, " + o2 + "."
                        reprompt_text = "Say your number by saying, my number is " + o1+ " or, " + o2 + "."
                    else:
                        speech_output = "<audio src='soundbank://soundlibrary/ui/gameshow/amzn_ui_sfx_gameshow_negative_response_01'/>"\
                                        "Haanji. What you are trying to pull buddy? You have already completed the game. <break/>" \
                                       "You can exit by saying stop"
                        card_output = "Haanji. What you are trying to pull buddy? You have already completed the game. " \
                                       "You can exit by saying stop"
                ...
                if n1 == c1+1 or n1 == c1+2:
                    ...
                    if int(comp_num)==19:
                        ...
                        speech_output = "<audio src='soundbank://soundlibrary/ui/gameshow/amzn_ui_sfx_gameshow_player3_01'/>"\
                                        "My number is " + \
                                        comp_num + ". Your turn! <break/>" \
                                        "Say your number by saying my number is "+ o1+\
                                        ".<audio src='soundbank://soundlibrary/ui/gameshow/amzn_ui_sfx_gameshow_player1_01'/>"
                        card_output = "My number is " + \
                                        comp_num + ". Your turn! " \
                                       "Say your number by saying my number is " + o1+"."
                ...
                if session.get('attributes', {}) and "ComputerNumber" in session.get('attributes', {}):
                    ...
                    comp_old_num="0"
                session_attributes = computer_number(comp_old_num)
                speech_output = "<say-as interpret-as='interjection'>oh dear!</say-as><break/> Say a valid number. " \
                                "Please try again."
                card_output = "Oh dear! Say a valid number. " \
                                "Please try again."
        ...
        speech_output = "<say-as interpret-as='interjection'>arey!</say-as><break/> First say start game to start the game. " 
        card_output = "Arey! First say start game to start the game. " 
        reprompt_text = "First say start game to start the game. "
    return build_response(session_attributes, build_speechlet_response(
        card_title, speech_output, card_output,reprompt_text, should_end_session))
...
def get_help_response(intent, session):
    ...
    if rulecount == 1:
        speech_output = "This is a counting number game and the rules are simple. <break/>" \
                        "The objective of the game is to be the first one to say 21. <break/>"\
        ...
        card_output = "This is a counting number game and the rules are simple. " \
                        "The objective of the game is to be the first one to say 21. "\
                        "I will play with you, and say the number one more than or two more than your number. "
    else:
        speech_output = "Hi! Welcome to Target Twenty One! <break/>" \
						...
						"Whoever says 21 first wins the game. <break/>"\
        ...
        card_output = "Hi! Welcome to Target Twenty One! " \
						...
						"Whoever says 21 first wins the game. "\
    ...
    if rulecount==0:
        ...
        reprompt_text = "Hey there! What are you waiting for? " \
                        "Say start game to start the game! or the number."
    else:
...
def fallBackIntent(intent, session):
    ...
    if int(comp_old_num)<21:
        ...
        speech_output = "<say-as interpret-as=\"interjection\">Uh oh.</say-as> <break/> You have spoken something different from utterances, Please try again! <break/>"\
                        "Say your number by saying my number is "+ o1+ " ,or, " + o2 +\
                        ".<audio src='soundbank://soundlibrary/ui/gameshow/amzn_ui_sfx_gameshow_player1_01'/>"
    
        card_output = "Uh oh! You have spoken something different from utterances, Please try again! "\
                        "Say your number by saying, my number is " + o1+ " or, " + o2 + "."
